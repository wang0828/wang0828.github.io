...
public partial class ns : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand cmd1 = new SqlCommand("insert into tsb(bh,mz,zz,cbs,sl,wz)    values('" + TextBox1.Text + "' ,'" + TextBox2.Text + "' ,'" + TextBox3.Text + "','" + TextBox4.Text + "' ,'" + TextBox5.Text + "'  ,'" + TextBox6.Text + "')", conn1);
        conn1.Open();//打开连接
